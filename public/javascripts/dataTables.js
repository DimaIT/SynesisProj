...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat(lang) {
		...
		if (!lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "В таблице нет доступных данных") {
	...
	function _fnGetCellData(settings, rowIdx, colIdx, type) {
		...
		if (cellData === undefined) {
			if (settings.iDrawError != draw && defaultContent === null) {
				_fnLog(settings, 0, "Запрошен неизвестный параметр " +
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Отображается от _START_ до _END_ из _TOTAL_ записей",
			 ...
			 *    } );
			 */
			"sZeroRecords": "Не найдено записей, удовлетворяющих запросу"
		},
